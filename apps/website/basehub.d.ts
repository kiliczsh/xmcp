...
export type SidebarTreeComponentOrderByEnum =
  | "_sys_createdAt__ASC"
  | "_sys_createdAt__DESC"
  | "_sys_hash__ASC"
  | "_sys_hash__DESC"
...
export interface ArticleComponentFilterInput {
  AND?: ArticleComponentFilterInput | null;
  OR?: ArticleComponentFilterInput | null;
...
export interface DocumentationGenqlSelection {
  ...
  _sys?: BlockDocumentSysGenqlSelection;
  _title?: boolean | number;
  articles?: ArticlesGenqlSelection & {
    __args?: {
      /** Filter by a field. */
  ...
  sidebarTree?: SidebarTreeGenqlSelection & {
    __args?: {
      /** Filter by a field. */
...
export interface SidebarTreeComponentFilterInput {
  AND?: SidebarTreeComponentFilterInput | null;
  OR?: SidebarTreeComponentFilterInput | null;
  _id?: StringFilter | null;
  _slug?: StringFilter | null;
  _sys_apiNamePath?: StringFilter | null;
  _sys_createdAt?: DateFilter | null;
  ...
  _sys_title?: StringFilter | null;
  _title?: StringFilter | null;
  collection?: ListFilter | null;
  target?: SidebarTreeComponentFilterInput__target_0___article | null;
}
...
export interface _componentsGenqlSelection {
  article?: articleComponent_AsListGenqlSelection & {
    __args?: {
      /** Filter by a field. */
      filter?: ArticleComponentFilterInput | null;
      /** Limit the number of items returned. Defaults to 500. */
  ...
  sidebarTree?: sidebarTreeComponent_AsListGenqlSelection & {
    __args?: {
      /** Filter by a field. */
      filter?: SidebarTreeComponentFilterInput | null;
      /** Limit the number of items returned. Defaults to 500. */
